...
All the environments are registered in the `Isaac_GoC_MPC` extension. They start
...
import Isaac_GoC_MPC.tasks  # noqa: F401


def main():
    """Print all environments registered in `Isaac_GoC_MPC` extension."""
